...
public class Variance extends AbstractStorelessUnivariateStatistic implements Serializable, WeightedEvaluation {
    ...
    public double evaluate(final double[] values, final double[] weights,
        ...
        if (test(values, weights,begin, length)) {
            ...
            if (length == 1) {
                ...
                var = (double) evaluate(values, weights, m, begin, length).get("variance");
            }
        }
        return var;
    }
     ...
     * @since 2.1
     */
    public Map<String, Object> evaluate(final double[] values, final double[] weights,
    ...
    public double evaluate(final double[] values, final double[] weights, final double mean) {
        return (double) evaluate(values, weights, mean, 0, values.length).get("variance");
    }
